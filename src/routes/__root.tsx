...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "نخبة تسكين العقارية — TAAM" },
      { name: "description", content: "نظام إدارة وتشغيل نخبة تسكين العقارية" },
      { name: "application-name", content: "TAAM" },
      { name: "apple-mobile-web-app-title", content: "TAAM" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "theme-color", content: "#086c6b" },
      { name: "msapplication-TileColor", content: "#086c6b" },
      { name: "msapplication-TileImage", content: faviconAsset.url },
      { property: "og:title", content: "نخبة تسكين العقارية — TAAM" },
      { name: "twitter:title", content: "نخبة تسكين العقارية — TAAM" },
      { property: "og:description", content: "نظام إدارة وتشغيل نخبة تسكين العقارية" },
      { name: "twitter:description", content: "نظام إدارة وتشغيل نخبة تسكين العقارية" },
