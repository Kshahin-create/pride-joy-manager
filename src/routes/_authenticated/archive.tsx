...
const TABLES: ArchivableTable[] = [
  ...
  { key: "parking_spots", label: "المواقف", nameField: "spot_code", codeField: "spot_code", scoped: true },
  { key: "tickets", label: "الشكاوى والطلبات", nameField: "title", codeField: "ticket_number", scoped: true },
  { key: "maintenance_requests", label: "طلبات الصيانة", nameField: "title", codeField: "request_number", scoped: true },
  ...
  { key: "spaces", label: "المساحات", nameField: "name", scoped: true },
